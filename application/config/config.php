...
defined('WEB_PATH') OR exit('Web path not defined.');
defined('WEB_URL') OR exit('Web url not defined.');
...
spl_autoload_register(function($namespace){
    ...
    if( strpos($namespace,'\\') !== false ) {
        ...
        // standard namespace starts with capitalized foldername
        $class_parts = explode('\\', $namespace);
        $base_dir = array_shift($class_parts);
        $base_dir = strtolower($base_dir) . "/";

        // if first string is "\", or root
        if (strpos("\\", $namespace) === 0) {
            array_shift($class_parts);
        }

        // custom namespacing
        if( strpos($namespace,'Model\\') !== false ) {
            $base_dir = 'models/';
        }

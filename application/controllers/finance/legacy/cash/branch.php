...
if ($p1=="Save Checked")
{
	...
	while ($ctr < count($mark))
	{
		...
		if ($branch[$c]!='')
		{
			...
			if ($branch_id[$c] == '')
			{
				$q = "insert into branch (enable, branch, branch_address, init_balance)
					values
						('".$enable[$c]."','".$branch[$c]."','".$branch_address[$c]."','".$init_balance[$c]."')";
...
<form name="form1" method="post" action="">
  ...
  <table width="60%" border="0" cellspacing="1" cellpadding="1" bgcolor="#EFEFEF" align="center">
    <tr bgcolor="#C8D7E6"> 
      <td colspan="5" height="27"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b> 
    ...
    <tr bgcolor="#E9E9E9"> 
      ...
      <td width="20%" nowrap><a href="<?=$href.'&sort=branch&start=$start&xSearch=$xSearch';?>"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#000000">Branch</font></b></a></td>
      ...
      <td nowrap><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#000000">Init.Bank 
        Bal.</font></b></td>
    ...
    <tr bgcolor="#FFFFFF" onMouseOver="bgColor='#FFFFCC'" onMouseOut="bgColor='#FFFFFF'"> 
      ...
      <td ><input name="branch_address[]2" type="text" id="<?='k'.$c;?>"  onChange="vChk(this)" size="50"> 
      </td>
      <td ><input name="init_balance[]" type="text"  id="<?='k'.$c;?>"  onChange="vChk(this)" size="10"></td>
      <td> 
    ...
    <tr  bgcolor=<?= ($r->enable=='N')? '#FFCCCC' :'#FFFFFF';?>> 
      ...
      <td><input name="branch_address[]" type="text" id="<?='k'.$ctr;?>"  onChange="vChk(this)" value="<?=$r->branch_address;?>" size="50"> 
      </td>
      <td><input name="init_balance[]" type="text" id="<?='k'.$ctr;?>" value="<?=$r->init_balance;?>" onChange="vChk(this)" size="10"></td>
      <td> 

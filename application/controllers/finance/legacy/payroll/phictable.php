...
<?
if (!chkRights2("ssstable","mview",$ADMIN['admin_id']))
{
...
if ($p1=="Save Checked" && $aphictable['status']=='INSERT' && chkRights2("phictable","madd",$ADMIN['admin_id']))
{
	$c=0;
//	print_r($income_from);
//	echo "here ";exit;
...
elseif ($p1=="Save Checked" && $aphictable['status']=='LIST' && chkRights2("phictable","medit",$ADMIN['admin_id']))
{
	$c=0;

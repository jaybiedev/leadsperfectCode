...
<?
if (!chkRights2('wtaxtable','mview',$ADMIN['admin_id']))
{
...
if ($p1=="Save Checked" && $awtaxtable['status']=='INSERT' and chkRights2('wtaxtable','madd',$ADMIN['admin_id']))
{
	$c=0;
//	print_r($income_from);
//	echo "here ";exit;
...
elseif ($p1=="Save Checked" && $awtaxtable['status']=='LIST' and chkRights2('wtaxtable','medit',$ADMIN['admin_id']))
{
	$c=0;

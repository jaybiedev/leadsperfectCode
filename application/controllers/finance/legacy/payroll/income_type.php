...
<?
$href = '?p=income_type';
if (!chkRights2('income_type','mview',$ADMIN['admin_id']))
{
...
if ($p1=="Save Checked" && $aincome_type['status']=='INSERT' and chkRights2('income_type','madd',$ADMIN['admin_id']))
{
	$c=0;
//	print_r($income_from);
//	echo "here ";exit;
...
elseif ($p1=="Save Checked" && $aincome_type['status']=='LIST' and chkRights2('income_type','medit',$ADMIN['admin_id']))
{
	$c=0;

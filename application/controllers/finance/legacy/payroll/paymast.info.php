<?
if (chkRights2("paymast","mview",$ADMIN['admin_id']) or chkRights2("paymast","madd",$ADMIN['admin_id']) or chkRights2("paymast","medit",$ADMIN['admin_id']) or chkRights2("paymast","mdelete",$ADMIN['admin_id']) or chkRights2("hrempmast","medit",$ADMIN['admin_id']))
{
?>
    <table width="91%" border="0" align="center" cellpadding="1" cellspacing="1">
  <tr bgcolor="#F0F0F0"> 
    <td width="11%"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Birth 
      Date</font></td>
    <td width="28%" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px; vertical-align:text-top;"> <input name="date_birth" type="text" id="date_birth" value="<?= ymd2mdy($paymast['date_birth']);?>" size="12" onBlur="IsValidDate(this,'MM/dd/yyyy')" onKeyUp="setDate(this,'MM/dd/yyyy','en')"  onKeypress="if(event.keyCode==13) {document.getElementById('gender').focus();return false;}"> 
  ...
  <tr bgcolor="#E2E2E2"> 
    <td bgcolor="#F0F0F0" valign="top" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px;">Course/Degree</td>
    <td bgcolor="#F0F0F0" valign="top" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px;"><textarea name="course" cols="40" id="course"><?= $paymast['course'];?></textarea></td>
  </tr>
  <tr> 

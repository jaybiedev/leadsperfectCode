...
$fields_header = array('reference','date','paymast_id','cc','memo','regarding');
...
elseif ($p1 == 'Save' && $aMemo['paymast_id'] == '')
{
	message1("No Employee Specified...");
}
elseif ($p1 == 'Save' && $aMemo['regarding'] == '')
{
	message1("No Subject (Re) Specified...");
}
elseif ($p1 == 'Save')
{
	if ($aMemo['memo_id'] == '')
...
<form name="f1" method="post" action="">
  ...
  <table width="90%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#EFEFEF">
    <tr> 
      <td colspan="2" bgcolor="#003366"><font color="#FFFFCC" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Memo 
    ...
    <tr> 
      <td height="22"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Employee</font></td>
      <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">
        <select name="paymast_id" id="select" style="width:280"  onKeypress="if(event.keyCode==13) {document.getElementById('date').focus();return false;}">
    ...
    <tr> 
      <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Re:</font></td>
      <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
        <input name="regarding"   type="text" id="regarding" value="<?= $aMemo['regarding'];?>" size="50" maxlength="50">
        </font></td>
    </tr>
    <tr> 

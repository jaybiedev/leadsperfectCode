...
elseif ($p2=="Save Checked" && $apayroll_period['status']=='INSERT' && chkRights2("payroll","madd",$ADMIN['admin_id']))
{
	$c=0;
//	print_r($period1);
//	echo "here ";exit;
...
elseif ($p2=="Save Checked" && $apayroll_period['status']=='LIST' && chkRights2("payroll","medit",$ADMIN['admin_id']))
{
	$c=0;
...
<form name="form1" method="post" action="">
  <table width="65%" border="0" cellspacing="1" cellpadding="2" align="center">
	...
	$q = "select * from payroll.payroll_period where month=$month and year = $year";

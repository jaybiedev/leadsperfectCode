...
if ($p1=="Save Checked" && $assstable['status']=='INSERT' && chkRights2("ssstable","madd",$ADMIN['admin_id']))
{
	$c=0;
//	print_r($income_from);
//	echo "here ";exit;
...
elseif ($p1=="Save Checked" && $assstable['status']=='LIST' && chkRights2("ssstable","medit",$ADMIN['admin_id']))
{
	$c=0;

...
<?
if (!chkRights2('deduction_type','mview',$ADMIN['admin_id']))
{
...
if ($p1=="Save Checked" && $adeduction_type['status']=='INSERT' and chkRights2('deduction_type','madd',$ADMIN['admin_id']))
{
	$c=0;
...
elseif ($p1=="Save Checked" && $adeduction_type['status']=='LIST' and chkRights2('deduction_type','medit',$ADMIN['admin_id']))
{
	$c=0;
...
<form name="form1" method="post" action="">
  <table width="85%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr bgcolor="#C8D7E6"> 
      <td colspan="9" height="27"  background="../graphics/table_horizontal.PNG" ><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b><font color="#EFEFEF">Deduction 
    ...
    <tr bgcolor="#E9E9E9"> 
      ...
      <td width="18%"><a href="<?=$href.'&sort=deduction_code';?>"><font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">Code</font></a></td>
      <td width="21%"><a href="<?=$href.'&sort=deduction_code';?>"><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#000000">Description</font></a></td>
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="18%"> 
        <?= lookUpAssoc("basis[]",array("N/A"=>"N","Daily"=>"D","Hourly"=>"H","Monthly"=>"M","Loan"=>"L","Auto"=>"A","Manual"=>"U","Payable"=>"P"),"");?>
      </td>
    ...
    <tr  bgcolor=<?= ($r->enable=='N')? '#FFCCCC' :'#FFFFFF';?>> 
      ...
      <td width="18%"> 
        <?= lookUpAssoc("basis[]",array("N/A"=>"N","Daily"=>"D","Hourly"=>"H","Monthly"=>"M","Loan"=>"L","Auto"=>"A","Manual"=>"U","Payable"=>"P"),$r->basis);?>
      </td>

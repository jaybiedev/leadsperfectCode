...
<SCRIPT type=text/javascript>
	...
	Menu1 = new Array("File","", 11, 20, 100);
		Menu1_1 = new Array("Stocks Master", "?p=stock.accounting.browse", 0, 15, 120);
		Menu1_2 = new Array("Stock Category Group", "?p=../warehouse/category", 0, 15, 150);
		Menu1_3 = new Array("Stock Classification", "?p=../warehouse/classification", 0, 15, 150);
		Menu1_4 = new Array("-----------------------");
		Menu1_5 = new Array("Account Master", "?p=account.browse", 0, 15, 130);
		Menu1_6 = new Array("Supplier Master", "?p=supplier.browse", 0, 15, 130);
		Menu1_7 = new Array("Departments", "?p=department", 0, 15, 150);
		Menu1_8 = new Array("Sections", "?p=../section", 0, 15, 150);
		Menu1_9 = new Array("-----------------------");
		Menu1_10 = new Array("Product Master","?p=product", 0, 15, 150);
		Menu1_11 = new Array("Product Prototype","?p=prototype", 0, 15, 150);

	Menu2 = new Array("Transaction","", 4, 19, 100);
		Menu2_1 = new Array("Job Order Monitor", "?p=joborder.monitor", 0, 15, 130);
		Menu2_2 = new Array("", "", 0, 15, 130);
		Menu2_3 = new Array("", "", 0, 15, 130);
		Menu2_4 = new Array("", "", 0, 15, 130);
		Menu2_5 = new Array("", "", 0, 15, 130);
		Menu2_6 = new Array("", "", 0, 15, 130);
		
	Menu3 = new Array("Reports","", 9, 20, 100);
		Menu3_1 = new Array("Inventory Balances", "", 0, 15, 130);
		Menu3_2 = new Array("Inventory Costing", "", 0, 15, 130);
		Menu3_3 = new Array("Bin Card", "", 0, 15, 130);
		Menu3_4 = new Array("-------------------", "?p=", 0, 15, 130);
		Menu3_5 = new Array("Summary of PO", "?p=", 0, 15, 130);
		Menu3_6 = new Array("Summary of SRR", "?p=", 0, 15, 130);
		Menu3_7 = new Array("Summary of SI", "?p=", 0, 15, 130);
		Menu3_8 = new Array("-------------------", "?p=", 0, 15, 130);
		Menu3_9= new Array("Cost Accounting", "?p=../accounting/costaccounting", 0, 15, 130);

	Menu4 = new Array("Setup","", 3, 20, 100);
		Menu4_1 = new Array("Configuration", "?p=sysconfig", 0, 15, 130);
		Menu4_2 = new Array("Passwords", "?p=password", 0, 15, 130);
		Menu4_3= new Array("", "", 0, 15, 130);

...
if ($p1=="Save Checked")
{
	...
	while ($ctr < count($mark))
	{
		...
		if ($branch[$c]!='')
		{
			...
			if ($branch_id[$c] == '')
			{
				$q = "insert into branch (enable, branch, branch_code, branch_address, init_balance, printer_type,province)
					values
						('".$enable[$c]."','".$branch[$c]."','".$branch_code[$c]."','".$branch_address[$c]."','".$init_balance[$c]."','".$printer_type[$c]."','".$province[$c]."')";
...
<form name="form1" method="post" action="">
  ...
  <table width="97%" border="0" cellspacing="1" cellpadding="1" bgcolor="#EFEFEF" align="center">
    <tr bgcolor="#C8D7E6" background="../graphics/table_horizontal.PNG" > 
      <td colspan="7" height="27" background="../graphics/table_horizontal.PNG" ><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b> 
    ...
    <tr bgcolor="#E9E9E9"> 
      ...
      <td nowrap><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#000000">Printing</font></b></td>
      <td nowrap><b><font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">Province</font></b></td>
    ...
    <tr bgcolor="#FFFFFF" onMouseOver="bgColor='#FFFFCC'" onMouseOut="bgColor='#FFFFFF'"> 
      ...
      <td ><?=lookUpAssoc('province[]',array('NONE'=>'0','NEGROS'=>'1','PANAY'=>'2','LUZON'=>'3','MINDANAO'=>'4'),'');?></td>
      <td> 
    ...
    <tr  bgcolor=<?= ($r->enable=='N')? '#FFCCCC' :'#FFFFFF';?>> 
      ...
      <td><?=lookUpAssoc('province[]',array('NONE'=>'0','NEGROS'=>'1','PANAY'=>'2','LUZON'=>'3','MINDANAO'=>'4'),$r->province);?></td>
      <td> 

  ...
  <table width="99%" height="99%" border="2" align="left" cellpadding="1" cellspacing="1" bordercolor="#0000FF" bgcolor="#99FFFF">
    ...
    <tr valign="bottom"> 
      <td colspan="3"><font size="4">Smart Card </font>
        <input name="pin" type="password" id="pin" value="<?= $pin;?>" size="20" style="font-size:20" onChange="Ok.click()" onFocus="document.getElementById('Ok').disable=0"></td>
    </tr>
    <tr valign="bottom">
      <td colspan="3"><font size="4">Password&nbsp;&nbsp;&nbsp;</font>
        <input name="pwd" type="password" id="pwd" value="<?= $pwd;?>" size="20" style="font-size:20" onChange="Ok.click()" onFocus="document.getElementById('Ok').disable=0">
	  </td>
    </tr>
    <tr valign="bottom"> 

...
<?
if (chkRights2("hrempmast","mview",$ADMIN['admin_id'])) $rghts='hidden';
if (chkRights2("hrempmast","medit",$ADMIN['admin_id'])) 
{
	$rghts1='text';
	$rghts='hidden';
}	
if (chkRights2("paymast","mview",$ADMIN['admin_id'])) $rghts='text';
...
<table width="100%" border="0" align="center" cellpadding="1" cellspacing="1">
  ...
  <tr bgcolor="#EFEFEF"> 
    ...
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">
      <?= lookUpTable2('tempbranch_id','branch','branch_id','branch',$paymast['tempbranch_id']);?>
    </font></td>
  ...
  <tr bgcolor="#EFEFEF"> 
    ...
    <td colspan="2"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
	 ...
	 <?
		...
		{ ?>
			&nbsp;&nbsp;Days per year
			<input name="dayear" type="text" id="dayear" value="<?= $paymast['dayear'];?>" size="5" onBlur="vComputeSalary()" >
		<? }
	 ?> 
      </font></td>
  </tr>
  ...
  <tr bgcolor="#EFEFEF"> 
    ...
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">
      <input name="position" type="<?=rghts1;?>" id="position" value="<?= $paymast['position'];?>" size="30" />
    </font></td>
  ...
  <tr bgcolor="#EFEFEF"> 
    ...
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">
      <input name="biomatrix" type="<?=rghts1;?>" id="biomatrix" value="<?= $paymast['biomatrix'];?>" size="6" maxlength="6"  style="text-align:left"   onkeypress="if(event.keyCode==13) {document.getElementById('fixed_ssse').focus();return false;}" />
</font></td>
  ...
  <tr bgcolor="#EFEFEF"> 
    ...
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">
      <input name="date_employ" type="<?=rghts1;?>" id="date_employ" value="<?= ymd2mdy($paymast['date_employ']);?>" size="12" onblur="IsValidDate(this,'MM/dd/yyyy')" onkeyup="setDate(this,'MM/dd/yyyy','en')"  onkeypress="if(event.keyCode==13) {document.getElementById('tenureallowance').focus();return false;}">
      <img src="../graphics/dwn-arrow-grn.gif" alt="date_employ" width="12" height="12" onclick="popUpCalendar(this, f1.date_employ, 'mm/dd/yyyy')" /> </font><font size="2" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;&nbsp;&nbsp;</font></td>
  ...
  <tr bgcolor="#EFEFEF"> 
    ...
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">
    <input name="date_resign" type="<?=rghts1;?>" id="date_resign" value="<?= ymd2mdy($paymast['date_resign']);?>" size="12" onblur="IsValidDate(this,'MM/dd/yyyy')" onkeyup="setDate(this,'MM/dd/yyyy','en')"  onkeypress="if(event.keyCode==13) {document.getElementById('tenureallowance').focus();return false;}" />
    <img src="../graphics/dwn-arrow-grn.gif" alt="date_resign" width="12" height="12" onclick="popUpCalendar(this, f1.date_resign, 'mm/dd/yyyy')" /> </font></td>

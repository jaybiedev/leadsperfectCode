...
<SCRIPT language=Javascript><!--
	...
	Menu2 = new Array("Loans","?p=loan.releasing.browse", 15, 19, 100);
		Menu2_1 = new Array("Loan Releasing", "?p=loan.releasing.browse", 0, 19, 200);
		Menu2_2 = new Array("Overrides", "?p=override", 0, 19, 150);
		Menu2_3 = new Array("Insurance Payment", "?p=payinsure", 0, 19, 150);
		Menu2_4 = new Array("-------------------------------", "", 0, 19, 200);
		Menu2_5 = new Array("Summary of Loan Releases", "?p=report.releasing", 0, 19, 150);
		Menu2_6 = new Array("Insurance Ledger", "?p=insureledger", 0, 19, 150);
		Menu2_7 = new Array("--- Administration ------------", "", 0, 19, 200);
		//Menu2_5 = new Array("Adjusting Entry", "?p=loan.adjust", 0, 17, 150);
		Menu2_8 = new Array("Recalculate Loans Ledger", "?p=recalc", 0, 19, 150);
		Menu2_9 = new Array("Process Penalties", "?p=computepenalty", 0, 19, 150);
		Menu2_10 = new Array("Browse Penalties", "?p=penalty.browse", 0, 17, 150);
		Menu2_11 = new Array("-------------------------------", "", 0, 19, 200);
		Menu2_12 = new Array("Loan Deposit Summary", "?p=report.loandeposit", 0, 17, 150);
		Menu2_13 = new Array("Deposit Release Summary", "?p=report.depositrelease", 0, 17, 150);
		Menu2_14 = new Array("Interbranch Loan Transactions", "?p=report.interbranch_loan", 0, 17, 280);
		Menu2_15 = new Array("Releases Fully Paid in 5 months", "?p=report.paidin3", 0, 17, 280);
	...
	Menu5 = new Array("Loan Reports","", 28, 20, 100);
...
//		Menu5_5 = new Array("Summary of Payments", "?p=report.payment", 0, 20, 235);
		...
		Menu5_25 = new Array("Receivable Listing Names Only", "?p=report.receivable3", 0, 20, 235);
		Menu5_26 = new Array("Clients with no Transactions", "?p=report.nonmoving", 0, 20, 235);
		Menu5_27 = new Array("Customer Listing", "?p=report.customers2", 0, 20, 235);
		Menu5_28 = new Array("Insurance Due", "?p=report.insuredue", 0, 20, 235);

...
function vs(sid)
{
	xajax_pc_select_id(sid);
	return;
}
//-->
</script>
<div id="browsePLULayer" name="browsePLULayer"  style="position:absolute; width:600px; height:299px; z-index:1; left: 5%; top:20%; display:none;"> 
